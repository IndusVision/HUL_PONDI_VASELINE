...
PID_FILE = "workers.pid"  # Stores worker PIDs
STOP_FILE = "stop.flag"    # Signal file to stop monitoring
...
if __name__ == '__main__':
    ...
    worker_scripts = [
         os.path.join(ROOT_DIR, "vaseline_line_1","src", "ocr.py"),
        os.path.join(ROOT_DIR, "vaseline_line_1","src","after_filling.py"),
        os.path.join(ROOT_DIR, "vaseline_line_1","src", "before_filling.py"),
    ]
