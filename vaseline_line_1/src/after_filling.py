...
LOG_DIR = os.path.join(ROOT_DIR, "vaseline_line_1","logs","L1_af_log_files")
...
class CameraProcess:
    ...
    def __init__(self, json_content, defect_config, parent_id):
        ...
        self.camera_serial_no = '054121020065'
        ...
        self.plc = PLC(
            ...
            self.db_number, self.start_offset, self.bit_offset,self.recipe_start_offset,self.recipe_bit_offset,value=False
        )
        self.camera = Camera(
    ...
    def run(self):
        ...
        try:
            ...
            while (cv2.waitKey(1) & 0xFF) != ord('q'):
                ...
                cv2.imshow("Line 1 after filling", resized_frame)
...
if __name__ == "__main__":
    ...
    ocr_config_path = os.path.join(
        ROOT_DIR, "gui_python_config", "Line_1_Code_config.json")
