...
LOG_DIR = os.path.join(ROOT_DIR, "vaseline_line_1", "logs","L1_bf_log_files")
...
class CameraProcess:
    ...
    def __init__(self, json_content, defect_config, parent_id):
        ...
        self.camera_serial_no = '054121020056'
    ...
    def run(self):
        ...
        try:
            ...
            while (cv2.waitKey(1) & 0xFF) != ord('q'):
                ...
                cv2.imshow("before filling l1", resized_frame)
